...
class MealDetailsViewController: UIViewController, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        default_recipe.ingredients = ingredients
        default_recipe.name = recipeTitle
        default_recipe.instructions = instructions
        
        for item in default_recipe.ingredients {
        ...
        recipeDescription.text = default_recipe.instructions
